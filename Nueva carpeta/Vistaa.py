...
class Ventana(QMainWindow):
    def __init__(self): #Constructor de la clase
        ...
        loadUi(r"C:\Users\griss\Downloads\VentanaLogin.ui",self)
        self.setup()
...
class ventanaEmergente(QDialog):
    def __init__(self,ppal=None): #Constructor de la clase
        ...
        loadUi(r"C:/Users/griss\Downloads/ventanaemergente.ui",self)
        self.setup()
    
    def setup(self): # Llama al método setup, que está definido más adelante en la clase.
        #se programa la senal para el boton
        self.buttonBox.accepted.connect(lambda:self.close()) #cuando el botón se presiona, se ejecutará el método funcion().
